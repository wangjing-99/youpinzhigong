<template>
  <view class="container">
    ...
    <view class="viewport">
      <a hover-class="none" :href="'/pages/myshop/editItem?type=name&title=修改店名&text='+data.name" class="item">
      ...
      <a hover-class="none" :href="'/pages/myshop/editItem?type=name&title=修改店铺简介&text='+data.name" class="item">
