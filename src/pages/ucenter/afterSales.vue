      ...
      <div v-if="data.length>0">
        <div class="item" v-for="(itm,index) in data" :key="index">
          ...
          <div class="item-statu">
            ...
            <navigator v-if="itm.type==3" :url="'/pages/ucenter/refundInfo?service_id='+itm.item.service_id">查看详情</navigator>
            <navigator v-if="itm.type==1" :url="'/pages/ucenter/returnInfo?service_id='+itm.item.service_id">查看详情</navigator>
          </div>
        </div>
      </div>
